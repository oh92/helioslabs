...
RAW_TRADES = [
    ...
    # Trades 16-17: corrected for partial fills (dYdX indexer shows multiple fill prices)
    # Mar 27: SELL 0.0137@67763 + 0.0179@67762 → BUY 0.0316@66152 (VWAP entry: 67762.43)
    ("2026-03-27 08:45:00", "2026-03-27 23:30:00", "SHORT", 67762.43, 66152.0, 50.89, "primary_crosses_above_-0.1"),
    # Mar 28: BUY 0.0093@66913 + 0.0294@66915 + 0.005@66917 + 0.0097@66918 → SELL 0.0534@66620 (VWAP entry: 66915.38)
    ("2026-03-28 13:45:01", "2026-03-28 22:00:00", "LONG", 66915.38, 66620.0, -15.77, "primary_crosses_below_0.1"),
]
